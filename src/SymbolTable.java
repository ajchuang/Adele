...
public class SymbolTable {
    ...
    /* constants */
    public static final int M_TYPE_USER      = 0; // user-defined type
    public static final int M_TYPE_BOOLEAN   = 1;
    public static final int M_TYPE_CHAR      = 2;
    public static final int M_TYPE_INT       = 3;
    public static final int M_TYPE_FLOAT     = 4;
    public static final int M_TYPE_STRING    = 5;
    public static final int M_TYPE_VOID      = 6;
    public static final int M_TYPE_GRAPH     = 7;
